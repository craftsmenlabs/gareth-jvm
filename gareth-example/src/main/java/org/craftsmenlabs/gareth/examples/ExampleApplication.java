...
public class ExampleApplication {
    ...
    public static void main(final String[] args) {
        final ExperimentEnginePersistence experimentEnginePersistence = new FileSystemExperimentEnginePersistence.Builder()
                .build();
        final ExperimentEngineConfig experimentEngineConfig = new ExperimentEngineConfigImpl.Builder()
                ...
                .setIgnoreInvocationExceptions(false).build();
        final ExperimentEngine experimentEngine = new ExperimentEngineImplBuilder(experimentEngineConfig)
                .setExperimentEnginePersistence(experimentEnginePersistence).build();
