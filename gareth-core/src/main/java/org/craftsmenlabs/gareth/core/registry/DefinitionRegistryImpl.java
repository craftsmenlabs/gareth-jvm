...
public class DefinitionRegistryImpl implements DefinitionRegistry
{
	...
	{
		Map<String, Set<String>> allPatterns = new HashMap<>();
		allPatterns.put("assume", assumeDefinitions.keySet());
		allPatterns.put("baseline", baselineDefinitions.keySet());
		allPatterns.put("success", successDefinitions.keySet());
		allPatterns.put("failure", failureDefinitions.keySet());
		allPatterns.put("time", timeDefinitions.keySet());
		return allPatterns;
	}
